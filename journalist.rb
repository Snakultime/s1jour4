...
def number_in_array
array_journalist_number = []
@tableaujournalistes.each do |handle|
...
def search_aude
 aude = []
 @tableaujournalistes.map(&:downcase).each do |handle|
